...
export default function About () {
    return(
            <section className="container mainContainers about my-5">
                ...
                <div className="row mt-4">
                    <div className="col-md-6 col-lg-3">
                        <div className="about-inf">
                            <h4 className="inf-title banner-4">Name:</h4>
                            <p className="description">Deep Bansode</p>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-3">
                        <div className="about-inf">
                            <h4 className="banner-4">Email:</h4>
                            <p className="description">deepbansode1@gmail.com</p>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-3">
                        <div className="about-inf">
                            <h4 className="inf-title banner-4">Date of Birth:</h4>
                            <p className="description">01 July 2002</p>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-3">
                        <div className="about-inf">
                            <h4 className="inf-title banner-4">From:</h4>
